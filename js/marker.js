...
var calculatePosition = window.maps.calculatePosition;
var makePageActive = window.maps.makePageActive;
var makePinsBlock = window.maps.makePinsBlock;
var map = window.maps.map;
var makeApartment = window.maps.makeApartment;
var firstMovePin = window.maps.firstMovePin;
var NUM_OFFERS = 8;
